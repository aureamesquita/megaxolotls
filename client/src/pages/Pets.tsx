...
const mockPets: Pet[] = [
  {
    ...
    morphStage: "Axolol",
    image:
      "https://bi.fbcd.co/posts/axolotl-drawing-final-result-63bdad49f098a088673675.jpg",
  ...
  },
  {
    ...
    morphStage: "Axolump",
    image:
      "https://www.emilydrawing.com/wp-content/uploads/2024/09/How-To-Draw-an-Axolotl-Steps-10.jpg",
...
export default function Pets() {
  ...
  const [selectedRarity, setSelectedRarity] = useState<Pet["rarity"] | "all">(
    "all"
  );
  ...
  return (
    <div className="relative min-h-screen w-full overflow-hidden bg-gradient-to-br from-slate-950 via-purple-950 to-slate-950">
      ...
      >
        {/* Filters */}
        <motion.div
          className="mb-8 p-6 rounded-lg border border-neon-cyan/30 bg-black/40"
        ...
        >
          <div className="flex flex-col gap-6">
            ...
            <div>
              ...
              <div className="flex flex-wrap gap-2">
                {(
                  ["all", "Axolotl", "Future1", "Future2", "Future3"] as const
                ).map(species => (
                  <button
                    key={species}
        ...
        >
          {filteredAndSortedPets.map(pet => (
            <motion.div
              ...
              className={`relative p-4 rounded-lg border-2 transition-all cursor-pointer group overflow-hidden ${rarityBgColors[pet.rarity]}`}
              variants={itemVariants}
            ...
            >
              {/* Gradient background */}
              <div
                className={`absolute inset-0 bg-gradient-to-br ${rarityColors[pet.rarity]} opacity-0 group-hover:opacity-10 transition-opacity`}
              />

              {/* Content */}
              <div className="relative z-10">
                {/* Image */}
                <div className="mb-3 h-28 rounded-lg overflow-hidden bg-black/40 border border-neon-cyan/20">
                  <img
                    src={pet.image}
                    alt={pet.name}
                ...
                {/* Name & Level */}
                <div className="mb-2">
                  <h3 className="text-base font-bold text-neon-cyan truncate">
                    {pet.name}
                  </h3>
                ...
                {/* Rarity Badge */}
                <div
                  className={`inline-block px-2.5 py-1 rounded-full text-[10px] font-bold mb-3 bg-gradient-to-r ${rarityColors[pet.rarity]} text-white`}
                >
                ...
                <Button
                  ...
                  className="w-full h-8 text-xs bg-gradient-to-r from-neon-pink to-neon-cyan text-black font-bold hover:shadow-lg hover:shadow-neon-pink/50 transition-all"
                >
                  BATTLE
                </Button>
              </div>
        ...
        >
          ...
          >
            ...
            <p className="text-gray-400 mb-4">
              {selectedPet.species} • Lv. {selectedPet.level} •{" "}
              {selectedPet.morphStage}
            </p>
              ...
              <div className="flex justify-between items-center">
                ...
                <div className="flex-1 mx-3 h-2 bg-black/40 rounded-full overflow-hidden">
                  <div
                    ...
                    style={{
                      width: `${(selectedPet.stats.attack / 100) * 100}%`,
                    }}
                  />
                </div>
                <span className="text-red-400 font-bold">
                  {selectedPet.stats.attack}
                </span>
              </div>
              ...
              <div className="flex justify-between items-center">
                ...
                <div className="flex-1 mx-3 h-2 bg-black/40 rounded-full overflow-hidden">
                  <div
                    ...
                    style={{
                      width: `${(selectedPet.stats.defense / 100) * 100}%`,
                    }}
                  />
                </div>
                <span className="text-blue-400 font-bold">
                  {selectedPet.stats.defense}
                </span>
              </div>
              ...
              <div className="flex justify-between items-center">
                ...
                <div className="flex-1 mx-3 h-2 bg-black/40 rounded-full overflow-hidden">
                  <div
                    ...
                    style={{
                      width: `${(selectedPet.stats.speed / 100) * 100}%`,
                    }}
                  />
                </div>
                <span className="text-yellow-400 font-bold">
                  {selectedPet.stats.speed}
                </span>
              </div>
              ...
              <div className="flex justify-between items-center">
                ...
                <div className="flex-1 mx-3 h-2 bg-black/40 rounded-full overflow-hidden">
                  <div
                    ...
                    style={{
                      width: `${(selectedPet.stats.spAtk / 100) * 100}%`,
                    }}
                  />
                </div>
                <span className="text-purple-400 font-bold">
                  {selectedPet.stats.spAtk}
                </span>
              </div>
              ...
              <div className="flex justify-between items-center">
                ...
                <div className="flex-1 mx-3 h-2 bg-black/40 rounded-full overflow-hidden">
                  <div
                    ...
                    style={{
                      width: `${(selectedPet.stats.spDef / 100) * 100}%`,
                    }}
                  />
                </div>
                <span className="text-green-400 font-bold">
                  {selectedPet.stats.spDef}
                </span>
              </div>
            </div>
            ...
            <Button
              onClick={() =>
                setLocation(`/battle-demo?petId=${selectedPet.id}`)
              }
